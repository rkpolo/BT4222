...
def interactive_input():
	return render_template('interactive.html', prediction = "Hello")
...
def background_process():
	try:
		...
		sess = gpt2.start_tf_sess()
		gpt2.load_gpt2(sess, run_name='review_star_1_large')
		my_prediction = gpt2.generate(sess, run_name= 'review_star_1_large', length=50, prefix= lang, sample_delim = '<|endoftext|>', include_prefix=False, nsamples=3, return_as_list=True)
